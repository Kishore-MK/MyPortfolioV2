  ...
  return (
    <div className="p-6 md:p-8 h-full flex flex-col">
      <CardContent className="p-0 flex-grow grid grid-cols-1 md:grid-cols-2 gap-6">
        {blogs.map((blog) => (
          <Card key={blog.title} className="group overflow-hidden flex flex-col bg-background/50 border-border/50 hover:border-primary/50 transition-all duration-300 transform hover:-translate-y-1">
